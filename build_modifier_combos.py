    ...
    def build(self, modifier_keys_path, keys_path):
        ...
        for modifier_key in modifier_keys_dict:
            ...
            for key in cleaned_key_strokes_dict:
                ...
                inserted_stroke = modifier_keys_dict[modifier_key].replace(
                    "?", cleaned_key_strokes_dict[key]
                )
                modifier_combos_dict[inserted_modifier_key] = inserted_stroke
        dict_builder.write_dict(
            modifier_combos_dict, modifier_keys_path.replace("-keys", "-combos")
        )
...
if __name__ == "__main__":
    ...
    modifier_combos_builder.build(
        stenodicts_root + "/common/modifier-keys.md",
        stenodicts_root + "/common/keys.md",
    )
